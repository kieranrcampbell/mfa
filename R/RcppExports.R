...
calculate_pi <- function(y, c, k, pst, tau, eta, tau_c, collapse, log_w, log_result, experimental) {
    .Call('mfa_calculate_pi', PACKAGE = 'mfa', y, c, k, pst, tau, eta, tau_c, collapse, log_w, log_result, experimental)
}
